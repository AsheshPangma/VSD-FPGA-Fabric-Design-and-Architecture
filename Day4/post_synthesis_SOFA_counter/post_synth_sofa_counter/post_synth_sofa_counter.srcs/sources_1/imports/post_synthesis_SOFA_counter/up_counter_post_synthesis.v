...
module up_counter (
    ...
    wire \lut_$abc$159$new_n13__output_0_0 ;
    wire \lut_$abc$159$new_n17__output_0_0 ;
    wire \lut_$abc$159$new_n13__input_0_0 ;
    wire \lut_$abc$159$new_n17__input_0_0 ;
    wire \lut_n16_input_0_1 ;
    wire \lut_n20_input_0_3 ;
    ...
    wire \lut_$abc$159$new_n13__input_0_3 ;
    wire \lut_$abc$159$new_n17__input_0_2 ;
    wire \lut_n16_input_0_2 ;
    wire \lut_n20_input_0_2 ;
    wire \out[0]_input_0_0 ;
    wire \lut_$abc$159$new_n13__input_0_1 ;
    wire \lut_$abc$159$new_n17__input_0_1 ;
    wire \lut_n20_input_0_1 ;
    wire \out[1]_input_0_0 ;
    wire \lut_$abc$159$new_n13__input_0_2 ;
    ...
    //Interconnect
    fpga_interconnect \routing_segment_enable_output_0_0_to_lut_$abc$159$new_n13__input_0_0  (
        .datain(\enable_output_0_0 ),
        .dataout(\lut_$abc$159$new_n13__input_0_0 )
    );

    fpga_interconnect \routing_segment_enable_output_0_0_to_lut_$abc$159$new_n17__input_0_0  (
        .datain(\enable_output_0_0 ),
        .dataout(\lut_$abc$159$new_n17__input_0_0 )
    );

    fpga_interconnect \routing_segment_enable_output_0_0_to_lut_n16_input_0_1  (
        .datain(\enable_output_0_0 ),
        .dataout(\lut_n16_input_0_1 )
    );

    fpga_interconnect \routing_segment_enable_output_0_0_to_lut_n20_input_0_3  (
        .datain(\enable_output_0_0 ),
        .dataout(\lut_n20_input_0_3 )
    );
    ...
    fpga_interconnect \routing_segment_reset_output_0_0_to_lut_n28_input_0_1  (
    ...
    fpga_interconnect \routing_segment_reset_output_0_0_to_lut_n16_input_0_0  (
        .datain(\reset_output_0_0 ),
        .dataout(\lut_n16_input_0_0 )
    );

    fpga_interconnect \routing_segment_reset_output_0_0_to_lut_n20_input_0_0  (
        .datain(\reset_output_0_0 ),
        .dataout(\lut_n20_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_out[0]_output_0_0_to_lut_$abc$159$new_n13__input_0_3  (
        .datain(\latch_out[0]_output_0_0 ),
        .dataout(\lut_$abc$159$new_n13__input_0_3 )
    );

    fpga_interconnect \routing_segment_latch_out[0]_output_0_0_to_lut_$abc$159$new_n17__input_0_2  (
        .datain(\latch_out[0]_output_0_0 ),
        .dataout(\lut_$abc$159$new_n17__input_0_2 )
    );

    fpga_interconnect \routing_segment_latch_out[0]_output_0_0_to_lut_n16_input_0_2  (
        .datain(\latch_out[0]_output_0_0 ),
        .dataout(\lut_n16_input_0_2 )
    );

    fpga_interconnect \routing_segment_latch_out[0]_output_0_0_to_lut_n20_input_0_2  (
        .datain(\latch_out[0]_output_0_0 ),
    ...
    fpga_interconnect \routing_segment_latch_out[1]_output_0_0_to_lut_$abc$159$new_n13__input_0_1  (
        .datain(\latch_out[1]_output_0_0 ),
        .dataout(\lut_$abc$159$new_n13__input_0_1 )
    );

    fpga_interconnect \routing_segment_latch_out[1]_output_0_0_to_lut_$abc$159$new_n17__input_0_1  (
        .datain(\latch_out[1]_output_0_0 ),
        .dataout(\lut_$abc$159$new_n17__input_0_1 )
    );

    fpga_interconnect \routing_segment_latch_out[1]_output_0_0_to_lut_n20_input_0_1  (
        .datain(\latch_out[1]_output_0_0 ),
    ...
    fpga_interconnect \routing_segment_latch_out[2]_output_0_0_to_lut_$abc$159$new_n13__input_0_2  (
        .datain(\latch_out[2]_output_0_0 ),
        .dataout(\lut_$abc$159$new_n13__input_0_2 )
    );
    ...
    fpga_interconnect \routing_segment_latch_out[3]_output_0_0_to_lut_n28_input_0_0  (
    ...
    fpga_interconnect \routing_segment_lut_$abc$159$new_n13__output_0_0_to_lut_n28_input_0_2  (
        .datain(\lut_$abc$159$new_n13__output_0_0 ),
        .dataout(\lut_n28_input_0_2 )
    );

    fpga_interconnect \routing_segment_lut_$abc$159$new_n17__output_0_0_to_lut_n24_input_0_1  (
        .datain(\lut_$abc$159$new_n17__output_0_0 ),
    ...
    ) \lut_$abc$159$new_n13_  (
        .in({
            \lut_$abc$159$new_n13__input_0_3 ,
            \lut_$abc$159$new_n13__input_0_2 ,
            \lut_$abc$159$new_n13__input_0_1 ,
            \lut_$abc$159$new_n13__input_0_0 }),
        .out(\lut_$abc$159$new_n13__output_0_0 )
    );
    ...
    ) \lut_$abc$159$new_n17_  (
        .in({
            \lut_$abc$159$new_n17__input_0_2 ,
            \lut_$abc$159$new_n17__input_0_1 ,
            \lut_$abc$159$new_n17__input_0_0 }),
        .out(\lut_$abc$159$new_n17__output_0_0 )
    );
